...
In other words, you are given an array collection 
of objects. The predicate pre will be an object 
property and you need to return true if its value 
...
function truthCheck(collection, pre) {
    ...
    return !collection.map(element => Boolean(element[pre]))
    .includes(false);
}
